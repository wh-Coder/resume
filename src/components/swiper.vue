<template>
  <div class="vue-swiper">
    ...
    <swiper :list="demo02_list" style="width:85%;margin:0 auto;" :aspect-ratio="300/800"
    ...
    <swiper :list="demo03_list" auto style="width:80%;margin:0 auto;" height="180px" dots-class="custom-bottom"
            dots-position="center"></swiper>
    <br/>
    <br/>
    <divider>华丽的分割线</divider>
